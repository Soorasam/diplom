...
const faq = [
  ...
  },
  {
    ...
    a: "Нет. Водитель вручает товар лично в посёлке. Подтверждение получения и выплата — в приложении.",
  },
  {
  ...
  {
    q: "Где забрать заказ?",
    a: "У водителя в вашем посёлке на маршруте сбора. Время и место встречи сообщит водитель — устно, по телефону или при встрече. Статус заказа виден в приложении.",
  },
  {

          ...
          {groups.map((group) => {
            ...
            return (
              <li key={group.roundId}>
                <Card className={done ? "ui-stop-done" : "ui-stop-active"}>
                  ...
                  <div className="mt-3 h-2 overflow-hidden rounded-full bg-slate-100">
                    <div
                      className="ui-progress-fill h-full rounded-full transition-all"
                      style={{ width: `${pct}%` }}
                    />
                  </div>

                  {justCompletedRound === group.roundId ? (
                    <p className="ui-panel mt-3 px-3 py-2 text-sm font-medium ui-text-accent">
